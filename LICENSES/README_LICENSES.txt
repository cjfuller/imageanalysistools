...
Other dependencies that are not included as part of the pre-built binaries (but will be automatically fetched when building) include:

Bio-formats:

loci_tools.jar and ome_tools.jar (see https://github.com/openmicroscopy/bioformats for source code and license information).

ImgLib2:  see https://github.com/imagej/imglib for source code and license information

ImageJ2:  see https://github.com/imagej/imagej for source code and license information 
