 ...
 */
class LocalAnalysis private constructor() {
    ...
    companion object {
        ...
        fun processFileSet(am: AnalysisMetadata) {
            ...
            params.addIfNotSet(
                    "number_of_channels",
                    Parameter("number_of_channels", "number_of_channels", ParameterType.INTEGER_T, am.inputImages.imageCount, ""))
        ...
        fun generateDataOutputString(data: Quantification?, p: ParameterDictionary): String {
            ...
            for (label in sortedRegions) {
                ...
                for (m in intensityMeasurements) {
                    val bkg: Measurement = backgroundMeasurements.firstOrNull { it.measurementName == m.measurementName } ?: continue
        ...
        private fun getOutputMethodNameString(am: AnalysisMetadata): String {
            ...
            val splitMethodName = longMethodName!!.split("\\.".toRegex()).dropLastWhile(String::isEmpty).toTypedArray()
        ...
        private fun writeImageOutput(am: AnalysisMetadata) {
            ...
            val splitMethodName = outputParams.getValueForKey("method_name")!!
            ...
            if (am.method!!.storedImages.size == 1) {
                ...
                for ((imageCounter, i) in am.method!!.storedImages.withIndex()) {
        ...
        private fun writeParameterOutput(am: AnalysisMetadata) {
            ...
            val splitMethodName = pd.getValueForKey("method_name")!!
                    .split("\\.".toRegex())
