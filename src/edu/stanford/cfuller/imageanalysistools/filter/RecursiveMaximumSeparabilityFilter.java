	...
	public void apply(Image im) {
		...
		while(doRecursion && this.numRecs < MAX_RECURSIONS) {
			...
			for (int k = 0; k < h.getMaxValue() + 1; k++) {
				...
				ImageCoordinate lowerBound = ImageCoordinate.createCoord(lower_width, lower_height, 0, 0, 0);
				ImageCoordinate upperBound = ImageCoordinate.createCoord(upper_width + 1, upper_height + 1, 1, 1, 1);
